...
export async function POST(request: NextRequest) {
  try {
    ...
    const snapshot: DaemonStatsSnapshot = {
      ...
      last_autotrain_tick: body.last_autotrain_tick,
      ...
      autotrain_iterations_count: body.autotrain_iterations_count || 0,
      autotrain_stopped_count: body.autotrain_stopped_count || 0,
