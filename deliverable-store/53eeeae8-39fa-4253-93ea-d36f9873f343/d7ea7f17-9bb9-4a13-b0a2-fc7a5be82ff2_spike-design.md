...
1. `spike-design.md` — This document
2. `migration-053.sql` — Complete migration SQL
3. `types.ts` — TypeScript interfaces
4. `query-utils.ts` — Query utility functions
5. `dispatch-context.ts` — Dispatch context builder functions
