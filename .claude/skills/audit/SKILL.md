...
- **Suggested command**: Which command to use (prefer: /quieter, /normalize, /colorize, /adapt, /animate, /extract, /audit, /onboard, /harden, /delight, /distill, /bolder, /critique, /clarify, /polish, /optimize — or other installed skills you're sure exist)
...
Map issues to available commands. Prefer these: /quieter, /normalize, /colorize, /adapt, /animate, /extract, /audit, /onboard, /harden, /delight, /distill, /bolder, /critique, /clarify, /polish, /optimize. You may also suggest other installed skills you're sure exist, but never invent commands.
